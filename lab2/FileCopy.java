...
public class FileCopy {
  ...
  /**
   * Alternative file copy method, with simplified error handling structure.
   * Does not handle directories for output file, and gives few diagnostic
   * clues if an exception arises...
   */
  public static void simpleCopy(String from_name, String to_name) 
                    throws IOException{
    File from_file = new File(from_name);  // Get File objects from Strings
    File to_file = new File(to_name);
    
    // Now we try to copy the file, a buffer of bytes at a time.
